...
- [DecentralizedLV-LPDRV](https://github.com/matthewpanizza/DecentralizedLV-ULPDRV) - Ultra Low Power Driver board, a miniature LPDRV with special features like SPI and UART exposure for connecting peripherals.
